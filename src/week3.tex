...
\begin{center}
    \includegraphics{picture/week3/nonconvex curve& angle.pdf}
\begin{comment}
    \tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt        
...
\end{remark}
\subsection{Minkowski problem (1-dim)}
\begin{theorem}[1-dim Minkowski problem]\label{thm: Minkowski problem}
